const translations = {
  "zh-CN": {
    ...
    releaseBody: "Web 与 VOS 发布包通过 GitHub Releases 提供；iPhone、iPad 与 Mac 版请从 App Store 下载。",
    ...
    appleStoreMeta: "iPhone · iPad · Mac · App Store",
    openAppleAppStore: "前往 App Store",
    waitingRelease: "等待发布",
  ...
  en: {
    ...
    releaseBody: "Web and VOS packages are distributed through GitHub Releases. Download the iPhone, iPad, and Mac app from the App Store.",
    ...
    appleStoreMeta: "iPhone · iPad · Mac · App Store",
    openAppleAppStore: "Open in App Store",
